...
function agri_saas_enqueue_assets(): void
{
    ...
    wp_enqueue_style('agri-saas-app', AGRI_SAAS_URI . '/assets/css/app.css', ['leaflet'], AGRI_SAAS_VERSION);
    wp_enqueue_script('leaflet', 'https://unpkg.com/leaflet@1.9.4/dist/leaflet.js', [], '1.9.4', true);
    wp_enqueue_script('agri-saas-app', AGRI_SAAS_URI . '/assets/js/app.js', ['leaflet'], AGRI_SAAS_VERSION, true);
